...
[![Build Status](https://travis-ci.org/isisaddons/isis-module-publishmq.png?branch=master)](https://travis-ci.org/isisaddons/isis-module-publishmq)
...
Notes:
* Check for later releases by searching [Maven Central Repo](http://search.maven.org/#search|ga|1|isis-module-publishmq-dom)).
...
The `PublishMqService` defines the following API:

<pre>
public interface PublishMqService {
}
</pre>
