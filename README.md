...
<pre>
    ...
    isis.services.ServicesInstallerFromAnnotation.packagePrefix=
                    ...,\
                    org.isisaddons.module.servletapi.servletapi,\
                    ...

    isis.services = ...,\
                    org.isisaddons.module.servletapi.servletapiContributions,\
                    ...
</pre>

Notes:
* Check for later releases by searching [Maven Central Repo](http://search.maven.org/#search|ga|1|isis-module-servletapi-dom)).
* The `servletapiContributions` service is optional but recommended; see below for more information.
...
<pre>
public interface servletapiService {
}
</pre>
