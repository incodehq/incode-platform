...
public class ApplicationSetting_and_UserSetting_recreate5 extends FixtureScript {
    ...
    protected void execute(ExecutionContext executionContext) {
        ...
        executionContext.add(this, applicationSettingsServiceRW.newInt("demoSettingWebServiceRetries", "(Demo) ${symbol_pound} times to retry submitting web service retries before failing", 3));
