...
public class DemoInvoice_simulateRenderAsDoc {
    ...
    public Document ${symbol_dollar}${symbol_dollar}(
        ...
        // unlike documents that are generated from a template (where we call documentTemplate${symbol_pound}render), in this case
