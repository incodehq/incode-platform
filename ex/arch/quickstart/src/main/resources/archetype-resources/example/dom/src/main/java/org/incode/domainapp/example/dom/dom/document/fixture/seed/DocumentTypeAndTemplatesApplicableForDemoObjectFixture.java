...
public class DocumentTypeAndTemplatesApplicableForDemoObjectFixture extends DocumentTemplateFSAbstract {
    ...
    protected void execute(final ExecutionContext executionContext) {
        ...
        fmkTemplate = upsertDocumentClobTemplate(
                ...
                "Freemarker-html-cover-note-for-${symbol_dollar}{demoObject.name}", fmkRenderingStrategy,
                executionContext);
        ...
        siTemplate = upsertDocumentTextTemplate(
                ...
                "application/pdf",
                "${symbol_dollar}{demoObject.url}", sipcRenderingStrategy,
                "pdf-of-url-held-in-${symbol_dollar}{demoObject.name}", siRenderingStrategy,
                executionContext);
        ...
        xdpTemplate = upsertDocumentBlobTemplate(
                ...
                "${symbol_dollar}{demoObject.name}", fmkRenderingStrategy,
                executionContext);
