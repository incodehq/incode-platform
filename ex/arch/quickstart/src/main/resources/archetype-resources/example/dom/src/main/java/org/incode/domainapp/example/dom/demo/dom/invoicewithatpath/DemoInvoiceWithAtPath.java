...
public class DemoInvoiceWithAtPath implements Comparable<DemoInvoiceWithAtPath> {
    ...
    @Getter @Setter
    @Title(sequence = "1", prepend = "Invoice ${symbol_pound}")
    private int num;
    ...
    /**
     *  required by {@link org.incode.domainapp.example.dom.demo.fixture.data.DemoInvoiceData${symbol_pound}findUsing(ServiceRegistry2)}.
     */
    @Override
