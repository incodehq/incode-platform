...
public class SomeCommandSubscriber extends AbstractSubscriber {
    ...
    void scheduleBackgroundCommandsToCopyColourOver(final SomeCommandAnnotatedObject scao) {
        ...
        backgroundService2.executeMixin(SomeCommandAnnotatedObj_updateCopyOfColorBySubscribedBackgrndMixinAct.class, scao).${symbol_dollar}${symbol_dollar}(scao.getColour());
