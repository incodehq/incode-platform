...
public class IntegTestSpiModuleBootstrapIntegTest extends IntegrationTestAbstract3 {

    public IntegTestSpiModuleBootstrapIntegTest() {
        super(new IntegTestsSpiModule());
    }
