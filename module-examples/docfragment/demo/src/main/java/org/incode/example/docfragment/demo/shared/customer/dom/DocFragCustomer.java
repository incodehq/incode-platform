...
public class DocFragCustomer implements Comparable<DocFragCustomer> {

    @Builder
    public DocFragCustomer(final String title, final String firstName, final String lastName, final String atPath) {
        this.title = title;
    ...
    @Override
    public int compareTo(final DocFragCustomer other) {
