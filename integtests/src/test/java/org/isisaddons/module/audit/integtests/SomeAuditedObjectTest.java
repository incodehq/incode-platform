...
public class SomeAuditedObjectTest extends AuditModuleIntegTest {
    ...
    public void auditEntriesCreatedOnCommit() throws Exception {
        ...
        // given
        isisJdoSupport.executeUpdate("delete from IsisAddonsAudit.\"AuditEntry\"");
        container().flush();
        ...
        // then
        final List<Map<String, Object>> prior = isisJdoSupport.executeSql("SELECT * FROM IsisAddonsAudit.\"AuditEntry\"");
        ...
        // then
        final List<Map<String, Object>> after = isisJdoSupport.executeSql("SELECT * FROM IsisAddonsAudit.\"AuditEntry\"");
