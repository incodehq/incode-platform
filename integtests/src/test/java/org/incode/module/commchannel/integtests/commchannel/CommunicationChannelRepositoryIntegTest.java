...
public class CommunicationChannelRepositoryIntegTest extends CommChannelModuleIntegTest {
    ...
    public void setUpData() throws Exception {
        ...
        wrap(mixinNewPostalAddress(fredDemoOwner)).__(
                ...
                false);
        wrap(mixinNewPostalAddress(fredDemoOwner)).__(
                "Grange School", "Wavertree", null, "Liverpool", "L36 1QQ", "UK", "Work", "Fred Smith's work", false);

        wrap(mixinNewEmailAddress(billDemoOwner)).__("bill@yahoo.com", "Home", "Bill Jones' home email");
        ...
        wrap(mixinNewPostalAddress(billDemoOwner)).__(
                "Beatles Museum", "Albert Dock", null, "Liverpool", "L5 1AB", "UK", "Work", "Bill Jones's work", false);
