...
public class ApplicationSettingContributions extends AbstractService {
    ...
    public ApplicationSetting findNext(final ApplicationSetting current) {
        return firstMatch(
    ...
    public String disableFindNext(final ApplicationSetting current) {
    ...
    public ApplicationSetting findPrevious(final ApplicationSetting current) {
    ...
    public String disableFindPrevious(final ApplicationSetting current) {
