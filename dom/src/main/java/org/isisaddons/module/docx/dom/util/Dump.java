...
public class Dump {
    ...
    public static void main(String[] args) throws Exception {
        ...
        File file = new java.io.File(System.getProperty("user.dir") + "/" +
        		filename
                );
    ...
    public void partsList(PrintStream out) throws Exception {
        ...
        org.docx4j.openpackaging.packages.OpcPackage opcPackage = org.docx4j.openpackaging.packages.OpcPackage.load(file);
