package domainapp.modules.exampledom.wicket.excel.dom.demo;
...
public class ExcelWicketToDoItem implements Comparable<ExcelWicketToDoItem> {
    ...
    public String iconName() {
        return "ExcelWicketToDoItem-" + (!isComplete() ? "todo" : "done");
    }
    ...
    public ExcelWicketToDoItem completed() {
        setComplete(true);
        return this;
    }
    ...
    public ExcelWicketToDoItem notYetCompleted() {
        setComplete(false);
    ...
    public static class DependenciesComparator implements Comparator<ExcelWicketToDoItem> {
        ...
        public int compare(final ExcelWicketToDoItem p, final ExcelWicketToDoItem q) {
            ...
            return byDescription
                    .compound(Ordering.<ExcelWicketToDoItem>natural())
                    .compare(p, q);
        }
    }
    ...
    public void setDependencies(final SortedSet<ExcelWicketToDoItem> dependencies) {
    ...
    public List<ExcelWicketToDoItem> autoComplete0Add(final @MinLength(2) String search) {
        final List<ExcelWicketToDoItem> list = toDoItems.autoComplete(search);
    ...
    public String validateAdd(final ExcelWicketToDoItem toDoItem) {
    ...
    // validate the provided argument prior to invoking action
    public String validateRemove(final ExcelWicketToDoItem toDoItem) {
        if(!getDependencies().contains(toDoItem)) {
    ...
    // provide a drop-down
    public Collection<ExcelWicketToDoItem> choices0Remove() {
    ...
    public static class Predicates {
        ...
        public static Predicate<ExcelWicketToDoItem> thoseOwnedBy(final String currentUser) {
            return new Predicate<ExcelWicketToDoItem>() {
                @Override
                public boolean apply(final ExcelWicketToDoItem toDoItem) {
        ...
        public static Predicate<ExcelWicketToDoItem> thoseSimilarTo(final ExcelWicketToDoItem toDoItem) {
        ...
        public static Predicate<ExcelWicketToDoItem> thoseNot(final ExcelWicketToDoItem toDoItem) {
            return new Predicate<ExcelWicketToDoItem>() {
                @Override
                public boolean apply(final ExcelWicketToDoItem t) {
                    return t != toDoItem;
        ...
        public static Predicate<ExcelWicketToDoItem> thoseCategorised(final Category category) {
            return new Predicate<ExcelWicketToDoItem>() {
                @Override
                public boolean apply(final ExcelWicketToDoItem toDoItem) {
        ...
        public static Predicate<ExcelWicketToDoItem> thoseSubcategorised(
        ...
        public static Predicate<ExcelWicketToDoItem> thoseCategorised(
     ...
     */
    @Override
    public int compareTo(final ExcelWicketToDoItem other) {
