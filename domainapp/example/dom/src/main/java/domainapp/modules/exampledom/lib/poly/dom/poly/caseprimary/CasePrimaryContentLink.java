package domainapp.modules.exampledom.lib.poly.dom.poly.caseprimary;
...
@javax.jdo.annotations.Queries({
        @javax.jdo.annotations.Query(
                ...
                value = "SELECT "
                        + "FROM domainapp.modules.exampledom.lib.poly.dom.poly.caseprimary.CasePrimaryContentLink "
                        + "WHERE case == :case"),
        @javax.jdo.annotations.Query(
