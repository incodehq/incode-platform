...
import domainapp.modules.exampledom.module.document.dom.applicability.rmf.RenderModelFactoryOfDocumentAttachedToDemoInvoice;
...
public class DocumentTypesAndTemplatesFixture extends DocumentTemplateFSAbstract {
    ...
    protected void execute(final ExecutionContext executionContext) {
        ...
        final RenderingStrategy fmkRenderingStrategy = renderingStrategyRepository.findByReference(
                RenderingStrategiesFixture.REF_FMK);
