 ...
 * 
 */
public class DocxModuleApplication extends IsisWicketApplication {
    ...
    protected Module newIsisWicketModule() {
        ...
        final Module simpleOverrides = new AbstractModule() {
            ...
            protected void configure() {
                bind(String.class).annotatedWith(Names.named("applicationName")).toInstance("Docx Module App");
                ...
                bind(String.class).annotatedWith(Names.named("aboutMessage")).toInstance("Docx Module App");
    ...
    private static String readLines(final String resourceName) {
        try {
            List<String> readLines = Resources.readLines(Resources.getResource(DocxModuleApplication.class, resourceName), Charset.defaultCharset());
