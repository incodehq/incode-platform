...
@javax.jdo.annotations.Queries( {
        @javax.jdo.annotations.Query(
                ...
                value="SELECT "
                        + "FROM org.isisaddons.module.publishmq.dom.outbox.events.OutboxEvent "
...
public class OutboxEvent extends DomainChangeJdoAbstract implements HasTransactionId,
        RepresentsInteractionMemberExecution, HasUsername {

    public static abstract class PropertyDomainEvent<T>
            extends PublishMqModule.PropertyDomainEvent<OutboxEvent, T> { }
    public static abstract class CollectionDomainEvent<T>
            extends PublishMqModule.CollectionDomainEvent<OutboxEvent, T> { }
    public static abstract class ActionDomainEvent
            extends PublishMqModule.ActionDomainEvent<OutboxEvent> { }
