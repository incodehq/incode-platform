...
@DomainObject
public class PolyDemoCasePrimaryContentLinkForParty extends PolyDemoPolyDemoCasePrimaryContentLink {
    ...
    public static class InstantiationSubscriber extends AbstractSubscriber {
        ...
        public void on(final InstantiateEvent ev) {
            if(ev.getPolymorphicReference() instanceof PolyDemoParty) {
                ev.setSubtype(PolyDemoCasePrimaryContentLinkForParty.class);
            }
        }
    }
