...
public abstract class DocumentModuleIntegTestAbstract extends IntegrationTestAbstract {
    ...
    private static class DocumentModuleAppManifestForIntegTests extends DocumentModuleAppManifest {
        {
            withModules(DocumentModuleIntegTestAbstract.class, FakeDataModule.class);
        }
        @Override
