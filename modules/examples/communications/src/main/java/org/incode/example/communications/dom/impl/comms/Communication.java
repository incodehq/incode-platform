...
import org.incode.example.communications.dom.types.AtPathType;
import org.incode.example.communications.dom.types.SubjectType;
...
@Queries({
        @Query(
                ...
                value = "SELECT "
                        + "FROM org.incode.example.communications.dom.impl.comms.Communication "
                        + "WHERE this.correspondents.contains(correspondent) "
                        + "   && correspondent.channel == :communicationChannel  "
                        + " VARIABLES org.incode.example.communications.dom.impl.comms.CommChannelRole correspondent "),
        @Query(
