...
public class DocFragInvoice implements Comparable<DocFragInvoice> {

    @Builder
    public DocFragInvoice(final int num, final LocalDate dueBy, final int numDays, final String atPath) {
        this.num = num;
        this.dueBy = dueBy;
    ...
    @Override
    public int compareTo(final DocFragInvoice other) {
        return Ordering.natural().onResultOf(DocFragInvoice::getNum).compare(this, other);
    }
    ...
    public boolean equals(final Object o) {
        ...
        final DocFragInvoice that = (DocFragInvoice) o;
