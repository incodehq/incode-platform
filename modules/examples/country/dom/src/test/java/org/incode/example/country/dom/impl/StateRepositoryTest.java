...
public class StateRepositoryTest {
    ...
    public static class FindStateByReference extends StateRepositoryTest {
        ...
        public void happyCase() {
            ...
            Assertions.assertThat(finderInteraction[0].getFinderMethod()).isEqualTo(FinderInteraction.FinderMethod.FIRST_MATCH);
            Assertions.assertThat(finderInteraction[0].getResultType()).isEqualTo(State.class);
            Assertions.assertThat(finderInteraction[0].getQueryName()).isEqualTo("findByReference");
            Assertions.assertThat(finderInteraction[0].getArgumentsByParameterName().get("reference")).isEqualTo((Object) "*REF?1*");
            Assertions.assertThat(finderInteraction[0].getArgumentsByParameterName()).hasSize(1);
        }
    }
    ...
    public static class FindStatesByCountry extends StateRepositoryTest {
        ...
        public void happyCase() {
            ...
            Assertions.assertThat(finderInteraction[0].getFinderMethod()).isEqualTo(FinderInteraction.FinderMethod.ALL_MATCHES);
            Assertions.assertThat(finderInteraction[0].getResultType()).isEqualTo(State.class);
            Assertions.assertThat(finderInteraction[0].getQueryName()).isEqualTo("findByCountry");
            Assertions.assertThat(finderInteraction[0].getArgumentsByParameterName().get("country")).isEqualTo((Object) country);
            Assertions.assertThat(finderInteraction[0].getArgumentsByParameterName()).hasSize(1);
        }
    ...
    public static class AllStates extends StateRepositoryTest {
        ...
        public void happyCase() {
            ...
            Assertions.assertThat(finderInteraction[0].getFinderMethod()).isEqualTo(FinderInteraction.FinderMethod.ALL_INSTANCES);
        }
    }
