...
import org.incode.example.document.dom.impl.applicability.ApplicabilityRepository;
import org.incode.example.document.dom.impl.applicability.AttachmentAdvisor;
import org.incode.example.document.dom.impl.applicability.AttachmentAdvisorAttachToNone;
...
import org.incode.example.document.dom.impl.renderers.RendererFromBytesToBytesWithPreviewToUrl;
...
import org.incode.example.document.dom.impl.renderers.RendererFromCharsToCharsWithPreviewToUrl;
...
import org.incode.example.document.dom.types.FqcnType;
...
@Queries({
        @javax.jdo.annotations.Query(
                ...
                value = "SELECT "
                        + "FROM org.incode.example.document.dom.impl.docs.DocumentTemplate "
                        + "WHERE typeCopy   == :type "
                        + "   && atPathCopy == :atPath "
                        + "ORDER BY date DESC"
        ),
