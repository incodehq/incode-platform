...
@javax.jdo.annotations.Queries( {
    @javax.jdo.annotations.Query(
            ...
            value = "SELECT "
                    + "org.incode.domainapp.extended.module.fixtures.shared.todo.dom.WicketChartsDemoToDoItem "
...
@DomainObject(
        autoCompleteRepository = WicketChartsDemoToDoItemMenu.class
)
@DomainObjectLayout(
        named = "To Do Item",
...
public class WicketChartsDemoToDoItem implements Comparable<WicketChartsDemoToDoItem>, CalendarEventable, Locatable {
    ...
    private SortedSet<WicketChartsDemoToDoItem> dependencies = new TreeSet<>();
    ...
    public WicketChartsDemoToDoItem completed() {
        setComplete(true);
        return this;
    }
    ...
    public WicketChartsDemoToDoItem notYetCompleted() {
        setComplete(false);
    ...
    public WicketChartsDemoToDoItem updateCosts(
            @Nullable
            @javax.validation.constraints.Digits(integer=10, fraction=2)
    ...
    public WicketChartsDemoToDoItem add(
            final WicketChartsDemoToDoItem toDoItem) {
        getDependencies().add(toDoItem);
        return this;
    }
    public List<WicketChartsDemoToDoItem> autoComplete0Add(final @MinLength(2) String search) {
        final List<WicketChartsDemoToDoItem> list = toDoItems.autoComplete(search);
    ...
    public String validateAdd(final WicketChartsDemoToDoItem toDoItem) {
    ...
    public WicketChartsDemoToDoItem remove(
            final WicketChartsDemoToDoItem toDoItem) {
    ...
    // validate the provided argument prior to invoking action
    public String validateRemove(final WicketChartsDemoToDoItem toDoItem) {
        if(!getDependencies().contains(toDoItem)) {
    ...
    // provide a drop-down
    public SortedSet<WicketChartsDemoToDoItem> choices0Remove() {
    ...
    public List<WicketChartsDemoToDoItem> delete() {
    ...
    public static class Predicates {
        ...
        public static Predicate<WicketChartsDemoToDoItem> thoseOwnedBy(final String currentUser) {
            return toDoItem -> Objects.equal(toDoItem.getOwnedBy(), currentUser);
        }

        public static Predicate<WicketChartsDemoToDoItem> thoseCompleted(
                final boolean completed) {
            return t -> Objects.equal(t.isComplete(), completed);
        }

        public static Predicate<WicketChartsDemoToDoItem> thoseCategorised(final Category category) {
            return toDoItem -> Objects.equal(toDoItem.getCategory(), category);
        }

        public static Predicate<WicketChartsDemoToDoItem> thoseSubcategorised(
                final Subcategory subcategory) {
            return t -> Objects.equal(t.getSubcategory(), subcategory);
        }

        public static Predicate<WicketChartsDemoToDoItem> thoseCategorised(
    ...
    @Override
    public int compareTo(final WicketChartsDemoToDoItem other) {
    ...
    @javax.inject.Inject
    WicketChartsDemoToDoItemMenu toDoItems;
    //endregion
    ...
    public WicketChartsDemoToDoItem updateLocation(final Double longitude, final Double latitude) {
