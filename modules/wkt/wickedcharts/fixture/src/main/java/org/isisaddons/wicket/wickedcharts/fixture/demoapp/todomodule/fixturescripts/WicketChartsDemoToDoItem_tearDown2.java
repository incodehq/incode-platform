...
public class WicketChartsDemoToDoItem_tearDown2 extends FixtureScript {

    private final String user;

    public WicketChartsDemoToDoItem_tearDown2() {
        this(null);
    }

    public WicketChartsDemoToDoItem_tearDown2(String ownedBy) {
        this.user = ownedBy;
    }
    ...
    public void execute(ExecutionContext executionContext) {
        ...
        isisJdoSupport.executeUpdate(String.format(
                "delete "
                        ...
                        + "(select \"id\" from \"exampleDemo\".\"WicketChartsDemoToDoItem\" where \"ownedBy\" = '%s') ",
                ownedBy));

        isisJdoSupport.executeUpdate(String.format(
                "delete from \"exampleDemo\".\"WicketChartsDemoToDoItem\" "
