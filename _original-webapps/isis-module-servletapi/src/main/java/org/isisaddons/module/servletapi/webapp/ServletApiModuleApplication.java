package org.isisaddons.module.servletapi.webapp;
 ...
 * 
 */
public class ServletApiModuleApplication extends IsisWicketApplication {
    ...
    private static final String APP_NAME = "Servlet API Module Example App";
