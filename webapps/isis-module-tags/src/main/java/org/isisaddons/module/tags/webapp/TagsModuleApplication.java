package org.isisaddons.module.tags.webapp;
 ...
 * 
 */
public class TagsModuleApplication extends IsisWicketApplication {
    ...
    private static final String APP_NAME = "Tags Module Example App";
