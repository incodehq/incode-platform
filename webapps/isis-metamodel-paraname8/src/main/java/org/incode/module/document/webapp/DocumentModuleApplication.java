package org.incode.module.document.webapp;
...
public class DocumentModuleApplication extends IsisWicketApplication {
    ...
    private static final String APP_NAME = "Incode Document Module Demo";
