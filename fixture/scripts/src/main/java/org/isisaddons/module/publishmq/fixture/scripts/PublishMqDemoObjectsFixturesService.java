...
public class PublishMqDemoObjectsFixturesService extends FixtureScripts {

    public PublishMqDemoObjectsFixturesService() {
        super(PublishMqDemoObjectsFixturesService.class.getPackage().getName());
    }
    ...
    public Object installFixturesAndReturnFirst() {
        final FixtureScript script = findFixtureScriptFor(PublishMqDemoObjectsFixture.class);
