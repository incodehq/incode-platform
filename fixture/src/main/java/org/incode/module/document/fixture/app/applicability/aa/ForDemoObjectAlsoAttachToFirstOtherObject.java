...
public class ForDemoObjectAlsoAttachToFirstOtherObject extends
    ...
    protected List<AttachmentAdvisor.PaperclipSpec> doAdvise(
        ...
        return determinePaperclipSpecs(demoObject);
    }

    protected List<AttachmentAdvisor.PaperclipSpec> determinePaperclipSpecs(final Object domainObject) {

        final List<AttachmentAdvisor.PaperclipSpec> attachTo = Lists.newArrayList();

        attachTo.add(new AttachmentAdvisor.PaperclipSpec(null, domainObject));
        ...
        if(firstOtherObjectIfAny.isPresent()) {
            attachTo.add(new AttachmentAdvisor.PaperclipSpec("other", firstOtherObjectIfAny.get()));
        }
