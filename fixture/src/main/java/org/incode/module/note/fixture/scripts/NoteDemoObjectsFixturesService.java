...
public class NoteDemoObjectsFixturesService extends FixtureScripts {

    public NoteDemoObjectsFixturesService() {
        super(NoteDemoObjectsFixturesService.class.getPackage().getName());
    }
    ...
    public Object installFixturesAndReturnFirst() {
        final FixtureScript script = findFixtureScriptFor(NoteDemoObjectsFixture.class);
