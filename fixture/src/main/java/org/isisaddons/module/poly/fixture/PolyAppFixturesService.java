...
import org.isisaddons.module.poly.fixture.dom.app.homepage.HomePageService;
...
public class PolyAppFixturesService extends FixtureScripts {

    public PolyAppFixturesService() {
        super(PolyAppFixturesService.class.getPackage().getName(), MultipleExecutionStrategy.EXECUTE);
    }
