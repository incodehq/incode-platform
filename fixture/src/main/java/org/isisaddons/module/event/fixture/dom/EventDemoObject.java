...
import org.isisaddons.module.event.dom.Event;
import org.isisaddons.module.event.dom.EventRepository;
...
public class EventDemoObject implements EventSource, Comparable<EventDemoObject> {
    ...
    @Override
    public int compareTo(final EventDemoObject other) {
