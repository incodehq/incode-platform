 ...
 *  under the License.
 */
package org.isisaddons.module.event.fixture.scripts;
...
public class EventDemoObjectsFixturesService extends FixtureScripts {

    public EventDemoObjectsFixturesService() {
        super(EventDemoObjectsFixturesService.class.getPackage().getName());
    }
    ...
    public Object installFixturesAndReturnFirst() {
        final FixtureScript script = findFixtureScriptFor(EventDemoObjectsFixture.class);
