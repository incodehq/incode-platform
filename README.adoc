...
* `1.14.3` - fixes https://github.com/incodehq/incode-module-communications/issues/8[#8], https://github.com/incodehq/incode-module-communications/issues/9[#9], https://github.com/incodehq/incode-module-communications/issues/10[#10]; https://github.com/incodehq/incode-module-communications/issues/11[#11] (mixin names); https://github.com/incodehq/incode-module-communications/issues/12[#12] (primary doc); use link:https://github.com/incodehq/incode-module-document[document] module v1.14.5
