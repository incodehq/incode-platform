...
== What happens during bootstrapping
:link-v1: link:blob/master/webapp/src/main/resources/db/migration/V1__schema-simple.sql
:link-v2: link:blob/master/webapp/src/main/resources/db/migration/V2__table-simple_SimpleObject.sql
...
+
See link:blob/master/util/scripts/truncate-all-tables.sql[truncate-all-tables.sql] for a script that does this for MS SQL Server.
