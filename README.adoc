...
A subclass of the `NotableLink` abstract class is required (about link:https://github.com/incodehq/incode-module-note/blob/master/fixture/src/main/java/org/incode/module/note/fixture/dom/NotableLinkForDemoObject.java[50 lines of boilerplate])),
