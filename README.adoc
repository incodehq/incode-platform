...
image::http://yuml.me/34c12f41[link="http://yuml.me/34c12f41"]
...
The owned `CommunicationChannelOwnerLink` objects are never rendered directly in the UI.  Rather, the
