...
is the combination of the app tenancy, an alias type, and the alias reference (a simple string).
...
link:https://github.com/incodehq/incode-module-alias/blob/master/fixture/src/main/java/org/incode/module/alias/fixture/dom/alias/AliasForDemoObject.java[50 lines of boilerplate]
...
link:https://github.com/incodehq/incode-module-alias/blob/master/fixture/src/main/java/org/incode/module/alias/fixture/dom/alias/AliasForDemoObject.java[`AliasForDemoObject`]
subclass:
...
(ie link:https://github.com/incodehq/incode-module-alias/blob/master/fixture/src/main/java/org/incode/module/alias/fixture/dom/alias/AliasForDemoObject.layout.xml[`AliasForDemoObject.layout.xml`])
