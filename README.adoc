...
For each domain object that you want to be able to attach ``CommunicationChannel``s, simply have that entity implement
the `CommunicationChannelOwner` marker interface.
