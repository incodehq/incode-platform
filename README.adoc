= incode-module-integtestsupport
:_imagesdir: ./
:toc:

image:https://travis-ci.org/incodehq/incode-module-integtestsupport.png?branch=master[Build Status,link=https://travis-ci.org/incodehq/incode-module-integtestsupport]

This module, intended for use with link:http://isis.apache.org[Apache Isis], provides a set of testing utilities to support integration testing.
