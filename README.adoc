...
* `1.14.3` - fixes https://github.com/incodehq/incode-module-communications/issues/7[#8]; references link:https://github.com/incodehq/incode-module-document[document] module v1.14.4 +
* `1.14.2` - fixes https://github.com/incodehq/incode-module-communications/issues/7[#7]; references link:https://github.com/incodehq/incode-module-document[document] module v1.14.3 +
+
[WARNING]
====
This release is not backwardly compatible, due to change in signature of the `DocumentCommunicationSupport` service
====
