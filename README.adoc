...
* `1.14.3` - fixes https://github.com/incodehq/incode-module-communications/issues/8[#8] (extend cc2,cc3,bcc2); https://github.com/incodehq/incode-module-communications/issues/9[#9] (use link:https://github.com/incodehq/incode-module-document[document] module v1.14.5 SPI); https://github.com/incodehq/incode-module-communications/issues/10[#10] (find/recent docs for channel); https://github.com/incodehq/incode-module-communications/issues/11[#11] (mixin names); https://github.com/incodehq/incode-module-communications/issues/12[#12] (primary doc); https://github.com/incodehq/incode-module-communications/issues/13[#13] (find/recent docs for channel owner)
