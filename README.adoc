...
This profile is automatically enabled if the `idea.version` property is enabled (which it will be when running within IntelliJ).
...
<dependencies>
    <dependency>
        <groupId>org.incodehq.mavendeps</groupId>
...
* `1.14.0` - forked from com.danhaywood.mavendeps:isisintellij, bumped to 1.14.0 release
