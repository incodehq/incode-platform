 ...
 * 
 */
public class ExampleApplication extends IsisWicketApplication {
    ...
    private static String readLines(final String resourceName) {
        try {
            List<String> readLines = Resources.readLines(Resources.getResource(ExampleApplication.class, resourceName), Charset.defaultCharset());
