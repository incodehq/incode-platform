...
to omit `example` module (from command line):

[source,bash]
----
mvn clean install -pl \!example/embeddedcamel,\!example/dom,\!example/canonical,\!example/app,\!example -o
----


or just comment out/remove:
