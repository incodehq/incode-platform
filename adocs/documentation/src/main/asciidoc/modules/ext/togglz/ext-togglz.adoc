...
The module integrates both Togglz and uses Isis Addons' xref:../../dom/settings/dom-settings.adoc#[settings subdomain] for feature persistence.
...
This service uses the Isis Addons' xref:../../dom/settings/dom-settings.adoc#[settings subdomain] module for feature persistence.
