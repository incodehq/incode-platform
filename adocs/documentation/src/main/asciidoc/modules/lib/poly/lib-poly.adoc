...
The screenshots below show the example app's usage of the _poly_ module.

Home page when run the app shows 3 parties, 3 fixed assets which between them have 9 communication channels.
