...
This is specified using the xref:../rgant/rgant.adoc#_rgant_Action_commandDtoProcessor[`@Action#commandDtoProcessor()`] or xref:../rgant/rgant.adoc#_rgant_Property_commandDtoProcessor[`@Property#commandDtoProcessor()`] attribute.
For example:
