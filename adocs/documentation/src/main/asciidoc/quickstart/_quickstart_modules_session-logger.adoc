...
The xref:../modules/spi/sessionlogger/spi-sessionlogger.adoc#[session logger] module records each user session as the user logs in or logs out (or is timed out automatically).
