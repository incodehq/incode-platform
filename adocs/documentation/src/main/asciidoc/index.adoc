...
Most modules are independent of others; see each for full details.
...
The _starter app_ is intended to be used as a starting point for new apps, being preconfigured with the dependencies for all of the modules available in the Incode Platform.
It also includes an example submodule (easily excluded) which demonstrates the usage of these modules.
