 ...
 *  under the License.
 */
package org.isisaddons.module.event.app;
...
import org.isisaddons.module.event.fixture.EventFixtureModule;

/**
 * Bootstrap the application.
 */
public class EventModuleAppManifest implements AppManifest {
    ...
    public List<Class<?>> getModules() {
        return Arrays.asList(
                EventModule.class,
                EventFixtureModule.class,
                EventModuleAppModule.class
        );
    }
